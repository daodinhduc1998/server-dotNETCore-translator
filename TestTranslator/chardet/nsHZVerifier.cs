...
namespace Translator.chardet
{
    ...
    public class nsHZVerifier : nsVerifier
    {
        ...
        public nsHZVerifier()
        {
            ...
            m_cclass[0] = ((0 << 4 | 0) << 8 | 0 << 4 | 0) << 16 | (0 << 4 | 0) << 8 | 0 << 4 | 1;
            ...
            m_cclass[5] = ((0 << 4 | 0) << 8 | 0 << 4 | 0) << 16 | (0 << 4 | 0) << 8 | 0 << 4 | 0;
            ...
            m_cclass[15] = ((0 << 4 | 2) << 8 | 5 << 4 | 0) << 16 | (4 << 4 | 0) << 8 | 0 << 4 | 0;
            m_cclass[16] = ((1 << 4 | 1) << 8 | 1 << 4 | 1) << 16 | (1 << 4 | 1) << 8 | 1 << 4 | 1;
            m_cclass[17] = ((1 << 4 | 1) << 8 | 1 << 4 | 1) << 16 | (1 << 4 | 1) << 8 | 1 << 4 | 1;
            m_cclass[18] = ((1 << 4 | 1) << 8 | 1 << 4 | 1) << 16 | (1 << 4 | 1) << 8 | 1 << 4 | 1;
            m_cclass[19] = ((1 << 4 | 1) << 8 | 1 << 4 | 1) << 16 | (1 << 4 | 1) << 8 | 1 << 4 | 1;
            m_cclass[20] = ((1 << 4 | 1) << 8 | 1 << 4 | 1) << 16 | (1 << 4 | 1) << 8 | 1 << 4 | 1;
            m_cclass[21] = ((1 << 4 | 1) << 8 | 1 << 4 | 1) << 16 | (1 << 4 | 1) << 8 | 1 << 4 | 1;
            ...
            m_cclass[26] = ((1 << 4 | 1) << 8 | 1 << 4 | 1) << 16 | (1 << 4 | 1) << 8 | 1 << 4 | 1;
            ...
            m_cclass[30] = ((1 << 4 | 1) << 8 | 1 << 4 | 1) << 16 | (1 << 4 | 1) << 8 | 1 << 4 | 1;
            ...
            m_states[0] = ((eError << 4 | eError) << 8 | eStart << 4 | eStart) << 16 | (eStart << 4 | 3) << 8 | eError << 4 | eStart;
            m_states[1] = ((eItsMe << 4 | eItsMe) << 8 | eItsMe << 4 | eItsMe) << 16 | (eError << 4 | eError) << 8 | eError << 4 | eError;
            m_states[2] = ((eError << 4 | 4) << 8 | eStart << 4 | eStart) << 16 | (eError << 4 | eError) << 8 | eItsMe << 4 | eItsMe;
            m_states[3] = ((eError << 4 | 4) << 8 | 5 << 4 | 5) << 16 | (eError << 4 | 6) << 8 | eError << 4 | 5;
            m_states[4] = ((eError << 4 | 4) << 8 | eError << 4 | 4) << 16 | (4 << 4 | 4) << 8 | eError << 4 | 4;
            m_states[5] = ((eStart << 4 | eStart) << 8 | eStart << 4 | eStart) << 16 | (eStart << 4 | eStart) << 8 | eItsMe << 4 | 4;
