...
namespace Translation.chardet
{
    ...
    public class nsISO2022CNVerifier : nsVerifier
    {
        ...
        public nsISO2022CNVerifier()
        {
            ...
            m_cclass[5] = ((0 << 4 | 0) << 8 | 0 << 4 | 0) << 16 | (0 << 4 | 0) << 8 | 3 << 4 | 0;
            m_cclass[6] = ((0 << 4 | 0) << 8 | 0 << 4 | 0) << 16 | (0 << 4 | 0) << 8 | 0 << 4 | 0;
            m_cclass[7] = ((0 << 4 | 0) << 8 | 0 << 4 | 0) << 16 | (0 << 4 | 0) << 8 | 0 << 4 | 0;
            m_cclass[8] = ((0 << 4 | 0) << 8 | 0 << 4 | 0) << 16 | (4 << 4 | 0) << 8 | 0 << 4 | 0;
            ...
            m_states[1] = ((eError << 4 | eError) << 8 | eError << 4 | eError) << 16 | (eError << 4 | eError) << 8 | eError << 4 | eStart;
            m_states[2] = ((eItsMe << 4 | eItsMe) << 8 | eItsMe << 4 | eItsMe) << 16 | (eItsMe << 4 | eItsMe) << 8 | eError << 4 | eError;
            m_states[3] = ((eError << 4 | 4) << 8 | eError << 4 | eError) << 16 | (eError << 4 | eItsMe) << 8 | eItsMe << 4 | eItsMe;
            m_states[4] = ((eError << 4 | eError) << 8 | eError << 4 | eError) << 16 | (eItsMe << 4 | eError) << 8 | eError << 4 | eError;
            m_states[5] = ((eError << 4 | eError) << 8 | eError << 4 | eError) << 16 | (eError << 4 | eError) << 8 | 6 << 4 | 5;
            m_states[6] = ((eError << 4 | eError) << 8 | eError << 4 | eError) << 16 | (eItsMe << 4 | eError) << 8 | eError << 4 | eError;
            m_states[7] = ((eStart << 4 | eError) << 8 | eItsMe << 4 | eError) << 16 | (eError << 4 | eError) << 8 | eError << 4 | eError;
