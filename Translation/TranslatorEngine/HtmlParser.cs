...
namespace Translation.TranslatorEngine
{
    public class HtmlParser
    {
        ...
        private static void LoadConfiguration()
        {
            ...
            titleTags = File.ReadAllLines(Path.Combine(directoryPath, @"Data\HtmlChapterTitleTags.config"));
            contentTags = File.ReadAllLines(Path.Combine(directoryPath, @"Data\HtmlChapterContentTags.config"));
            removedTags = File.ReadAllLines(Path.Combine(directoryPath, @"Data\HtmlRemovedTags.config"));
            dirty = false;
        }
    }
}
